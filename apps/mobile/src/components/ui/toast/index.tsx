...
const toastStyle = tva({
  ...
  variants: {
    action: {
      error: "bg-error-700 border-error-700/30",
      warning: "bg-warning-700 border-warning-700/30",
      success: "bg-success-700 border-success-700/30",
      info: "bg-info-700 border-info-700/30",
      muted: "bg-background-800 border-background-800/10",
    },
...
const toastTitleStyle = tva({
  base: "text-typography-0 font-orbitron-medium tracking-widest text-left",
  variants: {
    isTruncated: {
      true: "",
    },
