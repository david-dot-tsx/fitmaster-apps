...
const radioIconStyle = tva({
  base: "rounded-full justify-center items-center text-primary-800 fill-primary-800 data-[checked=true]:text-amber-400 data-[checked=true]:fill-amber-400 data-[checked=true]:stroke-amber-400",
...
const radioLabelStyle = tva({
  base: "text-typography-500 data-[checked=true]:text-amber-400 data-[hover=true]:text-typography-900 data-[hover=true]:data-[disabled=true]:text-typography-600 data-[hover=true]:data-[disabled=true]:data-[checked=true]:text-typography-900 data-[active=true]:text-typography-900 data-[active=true]:data-[checked=true]:text-typography-900 data-[disabled=true]:opacity-40 web:select-none",
  parentVariants: {
    size: {
      "2xs": "text-2xs",
      xs: "text-xs",
